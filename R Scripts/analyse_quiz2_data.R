...
quiz2 <- read.xlsx("data/scores_tidy.xlsx",sheetIndex=3)
...
textfile <- "data/group0_fishery_sustainability_defn_corrected.txt"
...
# Word cloud, horizontal bar plot and frequency table of bi/trigrams
textfile <- "data/group2_fishery_sustainability_defn_corrected.txt"
