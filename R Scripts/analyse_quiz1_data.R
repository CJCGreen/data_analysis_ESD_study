...
quiz1 <- read.xlsx("data/scores_tidy.xlsx",sheetIndex=2)
...
# Word cloud
textfile <- "data/general_feedback_on_learning_tool_corrected.txt"
...
feedback <- read.xlsx("data/scores_tidy.xlsx",sheetIndex=4)
...
# Word cloud
textfile <- "data/post_st_comments_corrected.txt"
...
# Qualitative feedback (comments):
# Word cloud
textfile <- "data/post_sim_comments_corrected.txt"
...
textfile <- "data/group0_deer_sustainability_defn_corrected.txt"
...
# Word cloud, horizontal bar plot and frequency table of bi/trigrams
textfile <- "data/group2_deer_sustainability_defn_corrected.txt"
myStopWords <- c("sustainability", "without", "can", "way", "using", 
                 "something", "will", "used", "certain", "use", "means", 
                 "think", "able", "deer", "taking", "adequate", "new", "per")
minWordFreq <- 3
