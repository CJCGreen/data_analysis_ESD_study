...
presurvey <- read.xlsx("RDataSources/scores_tidy_ORIGINAL_DO_NOT_DELETE.xlsx", sheetIndex=2)
...
barplot(quiz1_delays,
        ...
        ylab = "No of participants",
        col = brewer.pal(ncol(tbl_q1_delays), "Set2"))
